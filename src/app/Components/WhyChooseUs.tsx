...
export default function WhyChooseUs() {
  ...
  return (
    <div ref={ref} className="bg-white py-20 px-4 overflow-x-hidden">
                ...
                >
                  ...
                  <div className="flex-shrink-0 ml-4">
                    {openSection === section.id ? (
                      <ChevronUp className="w-6 h-6 text-gray-500 font-bold" strokeWidth={3} />
                    ) : (
                      <ChevronDown className="w-6 h-6 text-gray-500 font-bold" strokeWidth={3} />
                    )}
                  </div>
                </button>
