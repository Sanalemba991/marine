      ...
      <section className="relative">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              <p>
                We specialize in delivering high-quality marine and oilfield equipment 
                across the UAE and Middle East, providing innovative and reliable products.
              </p>
              
              <p>
                Our offerings include valves, Mild Steel, Galvanized Iron, Stainless Steel, 
                fittings, flanges, gasket sheets, rubber sheets, and Straub pipe repair solutions.
              </p>
              
              <p>
                Serving both marine and oil field industries, we prioritize performance, 
                durability, and safety in all our solutions.
              </p>
            </motion.div>
